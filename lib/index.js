...
setTimeout(function () {
  ...
  $("#breakfast-check").on('click', function(event){
      event.preventDefault()

  });
  $("#lunch-check").on('click', function(event){
      event.preventDefault()

  });
  $("#dinner-check").on('click', function(event){
      event.preventDefault()

  });
  $("#snacks-check").on('click', function(event){
      event.preventDefault()
      var checks = document.getElementsByName("checked");
      debugger
      // $('.snacks').append(
      //       `<tr class="food" id=${this.id} name="${diary}">
